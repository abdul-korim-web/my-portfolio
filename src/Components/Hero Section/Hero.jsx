...
const Hero = () => {
  ...
  return (
    <section className="max-w-full py-20 px-5 flex flex-col md:flex-row justify-center items-center md:space-x-10 space-y-10 md:space-y-0 bg-gray-100 dark:bg-gray-900">
      {/* Hero Image */}
